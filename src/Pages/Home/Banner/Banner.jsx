    ...
    return (
        <div className="carousel w-full lg:h-[736px] h-[660px]">
            <div className="carousel-item relative w-full">
                <img src={img} className="w-full bg-cover" />
                <div className="absolute flex items-center lg:pl-44 px-4 h-full">
                    <div className=' text-white space-y-7 lg:w-1/2 mt-28'>
                        ...
                        <button className="btn rounded-full w-[150px] border-none text-white">GET STARTED</button>
                    </div>
                </div>
            </div>
        </div>
